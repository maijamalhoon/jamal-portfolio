...
export const metadata: Metadata = {
  ...
  openGraph: { url: siteUrl, siteName: "Jamal Yaqoob Portfolio", title: "Jamal Yaqoob — Accounting, Finance & Systems", description: "Precise finance operations, reliable systems and thoughtful digital products.", type: "website", locale: "en_PK", images: [{ url: "https://avatars.githubusercontent.com/u/150429791?v=4", width: 410, height: 410, alt: "Jamal Yaqoob" }] },
  twitter: { card: "summary_large_image", title: "Jamal Yaqoob — Accounting, Finance & Systems", description: "Precise finance operations, reliable systems and thoughtful digital products.", images: ["https://avatars.githubusercontent.com/u/150429791?v=4"] },
