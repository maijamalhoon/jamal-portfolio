...
export const metadata: Metadata = {
  ...
  description:
    "Interactive portfolio of Jamal Yaqoob, an accounting and finance professional in Karachi combining dealership operations, finance systems, product thinking and computer science.",
  keywords: [
    "Jamal Yaqoob",
  ...
  openGraph: {
    ...
    title: "Jamal Yaqoob — Accounting, Finance & Systems",
    description: "Finance accuracy, systems intelligence and interactive proof of work.",
    type: "website",
    locale: "en_PK",
    images: [
      {
        url: "https://avatars.githubusercontent.com/u/150429791?v=4",
        width: 410,
        height: 410,
        alt: "Jamal Yaqoob",
      },
  ...
  return (
    <html lang="en" data-theme="noir" suppressHydrationWarning>
      <head>
        ...
        <script src={`${basePath}/enhancements.js`} defer />
      </head>
      <body>{children}</body>
    </html>
  );
